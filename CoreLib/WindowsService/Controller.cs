...
namespace CoreLib.WindowsService
{
    ...
    {
        public const string SERVICE_NAME = "VxShutdownTimerSvc";
        ...
        public static DataResult<ServiceStatus> CheckServiceStatus()
        {
            ...
            if (result.Success)
            {
                ...
                return new DataResult<ServiceStatus>(status, new MainResult(success, error));
            }
            return new DataResult<ServiceStatus>(ServiceStatus.NotRegistered, result);
        }
