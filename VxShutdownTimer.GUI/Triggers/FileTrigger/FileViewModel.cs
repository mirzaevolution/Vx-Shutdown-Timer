...
namespace VxShutdownTimer.GUI.Triggers.FileTrigger
{
    public class FileViewModel:BindableBase
    {
        ...
        public string FileLocation
        {
            ...
            set
            {
                OnPropertyChanged(ref _location, value, nameof(FileLocation));
            }
        }
        ...
        private void OnStart()
        {
            try
            {
                ...
                _watcher.Path = Path.GetDirectoryName(FileLocation);
                _watcher.Filter = Path.GetFileName(FileLocation);
        ...
        {
            return !IsRunning && !String.IsNullOrEmpty(FileLocation);
        }
