...
namespace VxShutdownTimer.GUI.Triggers.BatteryPercentTrigger
{
    ...
    public partial class BatteryPercentView : UserControl
    {
        ...
        private async void BatteryPercentViewModel_Info(object sender, string e)
        {
        ...
        private async void BatteryPercentViewModel_Error(object sender, string e)
        {
            if (_metroWindow != null)
            {
